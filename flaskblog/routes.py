...
def hello():
	...
	return render_template("home.html",posts=posts,title='mytiitle')

@app.route("/about")
def about():
	return render_template("about.html",title='about from main')
...
def login():
	...
	if  form.validate_on_submit():
		...
		if user and bcrypt.check_password_hash(user.password, form.password.data):
			...
			return render_template('login.html',title='un_success',form=form)
			r#eturn redirect(url_for('hello'))
		return render_template('login.html',title='login_succ',form=form)
...
def account():
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash(f'Current user has been updated', 'success')
